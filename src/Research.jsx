...
const Research = () => {
  ...
  research.forEach((researchTopic) => {
    ...
    researchLoad.push(<div className="researchCard bg-white rounded p-2 pr-10 pl-10 pb-5 pt-5">
        ...
        <div className="researchLead text-left font-bold">{researchTopic.researchLead}</div>
        <div className="researchDescImg flex gap-5 items-center">
          <div className="researchDescription  text-justify" dangerouslySetInnerHTML={{__html: researchTopic.researchDescription}}></div>
          <div className="researchImageHolder"><img src={researchTopic.researchImage}/></div>
        </div>
        <div className="resarchRelevant text-left">Relevant publications</div>
