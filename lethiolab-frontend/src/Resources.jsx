...
const Resources = () => {
  ...
  resources.forEach((resource) => {
    if (resource.resourceType === "product") {
      productLoad.push(<Link to={resource.resourceLink} target="_blank" className="resourceCard gap-2 flex flex-row rounded w-full p-2 bg-white pl-6 pr-6">
        <div className="resourceDetail w-1/2">
          <div className="resourceName text-left">{resource.resourceName}</div>
          <div className="resourceDescription text-left">{resource.resourceDescription}</div>
        </div>
      ...
      <div className="softwareImage w-1/2 h-auto text-center"><img src={resource.resourceImage} style={{height:"auto",width:"100%", marginLeft:"auto", marginRight:"auto", marginTop:"auto", marginBottom:"auto"}}></img></div>
    </Link>)
  ...
  return (
    <div className="resourceHolder w-8/12 h-fit mt-2 mr-auto ml-auto mb-2 flex flex-col pb-20 gap-5 pt-14">
      <div className="flex flex-col gap-3">
        <div className="resourceTitle text-left">Software</div>
      ...
      <div className="flex flex-col gap-3">
        <div className="resourceTitle text-left">Courses</div>
