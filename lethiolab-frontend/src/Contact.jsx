...
const Contact = () => {
	...
	const handleSubmit = (e) => {
		...
		tl.to([formRef.current, paperRef.current], {
			...
			.to([frontRef.current, paperRef.current, buttonRef.current] ,{
				duration: 0,
				autoAlpha: 0,
			}, '-=0.4') 
	...
	return (
		<>
			{!isMobile &&  <div className="contact-page">
				<div className="contact-page-links">
					<span className="contact-page-links-icons">
						...
						<a>
							<img src={facebook} width="35px" alt="Email icon" className="transition hover:scale-110"/> 
						</a>
						<a>
							<img src={linkedinSVG} width="35px" alt="Email icon" className="transition hover:scale-110"/> 
						</a>
				...
				<div className="contact-page-form">
					...
					>
						...
						<g id="paper" ref={paperRef}>
							<rect fill="#fff" stroke="#5EB4CB" strokeWidth=".25px" x="18.1" y="52" width="187.43" height="230.05" rx="9.02" ry="9.02"></rect>
						</g>
					</svg>
					...
					<form onSubmit={handleSubmit}>
						...
						<div className="contact-page-form-submit" ref={buttonRef}>
